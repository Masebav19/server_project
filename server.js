...
const {requestLoggerMiddleware} = require("./middlewares/request");
...
app.post('/put', requestLoggerMiddleware, async (req, res) => {
...
app.get('/last_video', requestLoggerMiddleware, (req,res)=>{
...
app.get('/video', requestLoggerMiddleware, (req,res)=>{
  res.render('video_stream.ejs',{estado: alarma_st});
})
app.get('/video_hist', requestLoggerMiddleware, async (req,res)=>{
...
app.get('/show_video_hist.ejs', requestLoggerMiddleware, (req,res)=>{
